...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2023 at 10:43 AM
...
--
-- Table structure for table `farby`
--
...
INSERT INTO `farby` (`id_farby`, `kolor`, `cena`, `pojemosc`) VALUES
(1, 'biały', 20, 5),
(2, 'czerwony', 30, 3),
(3, 'niebieski', 35, 3),
(4, 'żółty', 22, 4),
...
--
-- Table structure for table `malowanie`
--
...
--
-- Indexes for table `farby`
--
ALTER TABLE `farby`
  ADD PRIMARY KEY (`id_farby`);

--
-- Indexes for table `malowanie`
--
...
--
-- Constraints for table `malowanie`
--
ALTER TABLE `malowanie`
